...
class EpicStoryCliTest(unittest.TestCase):
    ...
    def test_story_difficulty_validates_warns_and_surfaces_from_plan(self) -> None:
        ...
        self.assertIn("kind: 必须是 large-task-story", invalid_kind.stderr)

    def test_story_without_difficulty_uses_default(self) -> None:
        story = json.loads(self.story_1.read_text(encoding="utf-8"))

...
| [ppt-visual-review](common-skills/ppt-visual-review/) | Layout-focused slide review: arrows, whitespace, same-type consistency, and global font/color checks. Loops subagent review → fix → re-review until clean, then delivers a whole-deck before/after HTML report. Explicit invocation only; honors read-only requests. |
